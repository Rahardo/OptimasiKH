...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 1 && args[0].equals("-p")) {
            ...
            int ants    = 5;          // Number of ants to run per generation.
            int gen     = 50;          // Number of generations.
            double evap = 0.1;          // Evaporation rate of pheromones.
            int alpha   = 1;            // Impact of pheromones on decision making. ada track. besar diambil
            int beta    = 2;            // Impact of distance on decision making.
